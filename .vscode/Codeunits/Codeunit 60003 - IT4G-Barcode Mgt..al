codeunit 60003 "IT4G-Barcode Mgt."
{
    // version IT4G,BARCODE v1
    SingleInstance = false;

    trigger OnRun();
    var
        //        lrecTmpBlob : Record "99008535" temporary;
        lrecTmpBlob: Codeunit "Temp Blob";
    begin
    end;
    ...
    var
        lrecTmpCode128: Record 60200 temporary;
        lintCount1: Integer;
    ...
    var
        lrecTmpCode39: Record 60200 temporary;
        lintCount1: Integer;
        lintSum: Integer;
        lintConvInt: Integer;
        lintCheckDigit: Integer;
    ...
    begin
        ...
        END ELSE BEGIN
            ...
            END;
            */
            // for better performance, write string for one line
    ...
    local procedure InitCode128(var precTmpCode128: Record 60200 temporary);
    begin
        precTmpCode128.INIT;
    ...
    local procedure InitCode39(var precTmpCode39: Record 60200 temporary);
    begin
